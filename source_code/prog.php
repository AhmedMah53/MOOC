        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center section-heading probootstrap-animate">
              <h2 class="mb0">Software</h2>
            </div>
          </div>
        </div>
        <div class="probootstrap-tab-style-1">
          <ul class="nav nav-tabs probootstrap-center probootstrap-tabs no-border">
            <li><a data-toggle="tab" href="#software">L'Web</a></li>
            <li><a data-toggle="tab" href="#math">Design</a></li>
            <li class="active"><a data-toggle="tab" href="#physic">Programming Languages</a></li>
          </ul>
        </div>
      </section>
                ...
                <div class="row">
                  ...
                  <?php 
                        if(isset($_SESSION['cname']))
                        {
                          ...
                          $result=mysqli_query($conn,$sql);
                          foreach (mysqli_fetch_assoc($result) as  $value) {
                            if($_SESSION['category']=="Programming Languages")
                            {
                                echo '
                                  <div class="probootstrap-service-2 probootstrap-animate">
                                    <div class="image">
