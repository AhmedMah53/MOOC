...
?>
        ...
        <div class="probootstrap-tab-style-1">
          <ul class="nav nav-tabs probootstrap-center probootstrap-tabs no-border">
            <li class="active" ><a data-toggle="tab" href="#star">stellar astronomy</a></li>
            <li><a data-toggle="tab" href="#gala">Galactic astronomy</a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="tab-content">
                ...
                <div id="star" class="tab-pane fade in active">
                  <div class="row">
                  <div class="col-md-12">
                      <?php 
