        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center section-heading probootstrap-animate">
              <h2 class="mb0">Physics</h2>
            </div>
          </div>
        </div>
        <div class="probootstrap-tab-style-1">
          <ul class="nav nav-tabs probootstrap-center probootstrap-tabs no-border">
            <li><a data-toggle="tab" href="#meca">Mechanical</a></li>
            <li><a data-toggle="tab" href="#electro">Electromagnetic</a></li>
            <li class="active" ><a data-toggle="tab" href="#nuclear">Nuclear physics</a></li>
            <li><a data-toggle="tab" href="#quantum">Quantum</a></li>
          </ul>
        </div>
      </section>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="tab-content">
                ...
                <div id="meca" class="tab-pane fade">
                  <div class="row">
                  <div class="col-md-12">
                      <?php 
                        if(isset($_SESSION['cname']))
                        {
                          ...
                          foreach (mysqli_fetch_assoc($result) as  $value) {
                            if($_SESSION['category']=="Mechanical")
                            {
                                echo '
                ...
                <div id="electro" class="tab-pane fade">
                  <div class="row">
                  <div class="col-md-12">
                      <?php 
                        if(isset($_SESSION['cname']))
                        {
                          ...
                          $result=mysqli_query($conn,$sql);
                          foreach (mysqli_fetch_assoc($result) as  $value) {
                            if($_SESSION['category']=="Electromagnetic")
                            {
                                echo '
                                  <div class="probootstrap-service-2 probootstrap-animate">
                                    <div class="image">
              ...
              <div id="Nuclear physics" class="tab-pane fade in active">
                <div class="row">
                <div class="col-md-12">
                      <?php 
                        if(isset($_SESSION['cname']))
                        {
                          ...
                          $result=mysqli_query($conn,$sql);
                          foreach (mysqli_fetch_assoc($result) as  $value) {
                            if($_SESSION['category']=="Nuclear physics")
                            {
                                echo '
                                  <div class="probootstrap-service-2 probootstrap-animate">
                                    <div class="image">
              ...
              <div id="quantum" class="tab-pane fade">
                <div class="row">
                <div class="col-md-12">
                      <?php 
                        if(isset($_SESSION['cname']))
