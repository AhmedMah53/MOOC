...
?>
        ...
        <div class="probootstrap-tab-style-1">
          <ul class="nav nav-tabs probootstrap-center probootstrap-tabs no-border">
            <li><a data-toggle="tab" href="#algebra">Algebra</a></li>
            <li><a data-toggle="tab" href="#analysis">Analysis</a></li>
            <li class="active" ><a data-toggle="tab" href="#proba">Probability</a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="tab-content">
                ...
                <div id="algebra" class="tab-pane fade">
                  <div class="row">
                    <div class="col-md-12">
                      <?php 
              ...
              <div id="proba" class="tab-pane fade in active">
                <div class="row">
                <div class="col-md-12">
                      <?php 
                        if(isset($_SESSION['cname']))
