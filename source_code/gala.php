        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center section-heading probootstrap-animate">
              <h2 class="mb0">Astronomy</h2>
            </div>
          </div>
        </div>
        <div class="probootstrap-tab-style-1">
          <ul class="nav nav-tabs probootstrap-center probootstrap-tabs no-border">
            <li><a data-toggle="tab" href="#star">stellar astronomy</a></li>
            <li class="active" ><a data-toggle="tab" href="#gala">Galactic astronomy</a></li>
            <li><a data-toggle="tab" href="#planet">Planetary science</a></li>
            <li><a data-toggle="tab" href="#cosmo">Cosmology</a></li>
          </ul>
        </div>
      </section>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="tab-content">
                      ...
                      <?php 
                        if(isset($_SESSION['cname']))
                        {
                          ...
                          foreach (mysqli_fetch_assoc($result) as  $value) {
                            if($_SESSION['category']=="Stellar astronomy")
                            {
                                echo '
                ...
                <div id="gala" class="tab-pane fade in active">
                  <div class="row">
                  <div class="col-md-12">
                      <?php 
                        if(isset($_SESSION['cname']))
                        {
                          ...
                          $result=mysqli_query($conn,$sql);
                          foreach (mysqli_fetch_assoc($result) as  $value) {
                            if($_SESSION['category']=="Galactic astronomy")
                            {
                                echo '
                                  <div class="probootstrap-service-2 probootstrap-animate">
                                    <div class="image">
              ...
              <div id="planet" class="tab-pane fade">
                <div class="row">
                <div class="col-md-12">
                      <?php 
                        if(isset($_SESSION['cname']))
                        {
                          ...
                          $result=mysqli_query($conn,$sql);
                          foreach (mysqli_fetch_assoc($result) as  $value) {
                            if($_SESSION['category']=="Planetary science")
                            {
                                echo '
                                  <div class="probootstrap-service-2 probootstrap-animate">
                                    <div class="image">
                ...
                <div id="cosmo" class="tab-pane fade">
                <div class="row">
                <div class="col-md-12">
                      <?php 
                        if(isset($_SESSION['cname']))
                        {
                          ...
                          $result=mysqli_query($conn,$sql);
                          foreach (mysqli_fetch_assoc($result) as  $value) {
                            if($_SESSION['category']=="Cosmology")
                            {
                                echo '
                                  <div class="probootstrap-service-2 probootstrap-animate">
                                    <div class="image">
