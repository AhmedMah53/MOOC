...
?>
        ...
        <div class="probootstrap-tab-style-1">
          <ul class="nav nav-tabs probootstrap-center probootstrap-tabs no-border">
            <li class="active" ><a data-toggle="tab" href="#meca">Mechanical</a></li>
            <li><a data-toggle="tab" href="#electro">Electromagnetic</a></li>
            <li><a data-toggle="tab" href="#nuclear">Nuclear physics</a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="tab-content">
                ...
                <div id="meca" class="tab-pane fade in active">
                  <div class="row">
                  <div class="col-md-12">
                      <?php 
              ...
              <div id="Nuclear physics" class="tab-pane fade">
                <div class="row">
                <div class="col-md-12">
                      <?php 
                        if(isset($_SESSION['cname']))
